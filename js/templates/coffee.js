...
`<div class="p-0 run-bar-runner coffee-container" style="color: inherit;">
    ...
    <span id="coffeeBtnTxt" style="color: inherit;">Cómprame un café :)</span>
</div>`;

coffeeNode.addEventListener("click", evt => {
    bootbox.dialog({
        title: "¡Muchas gracias por apoyar!",
        message: "Yo me encargaré de pagar el hosting y el dominio de la página, igualmente de dar soporte. Mientras speedrun.com no me solicite que se elimine, speedruñ.com existirá ;)"
